  ...
  QBWebConnectorSvc: {
    QBWebConnectorSvcSoap: {
      ...
      authenticate: function(args) {
        ...
        console.log(args);
        return {
          authenticateResult: { string: ["testSession", {}] }
        };
      },
      sendRequestXML: function(args) {
        ...
        console.log(("sendRequestXML Stub ", args));
      },
      closeConnection: function() {
        console.log("closeConnection Stub");
      },
      connectionError: function() {
        console.log("connectionError Stub");
      },
      getInteractiveURL: function() {
        console.log("getInteractiveURL Stub");
      },
      getLastError: function() {
        console.log("getLastError Stub");
      },
      interactiveDone: function() {
        console.log("interactiveDone Stub");
      },
      interactiveRejected: function() {
        console.log("interactiveRejected Stub");
      },
      receiveResponseXML: function() {
        console.log("receiveResponseXML Stub");
      }
    }
  }
};

var xml = Meteor.http.call('get', 'https://s3-us-west-2.amazonaws.com/metcrm/service.wsdl').content;

server = soap.listen(WebApp.httpServer, '/wsdl', myService, xml);
